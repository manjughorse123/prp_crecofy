...
export const SET_MEMBER_RECEIPTS = 'SET_MEMBER_RECEIPTS';
export const SET_MEMBER_CAMPAIGNS = 'SET_MEMBER_CAMPAIGNS';
export const REMOVE_MEMBER = 'REMOVE_MEMBER';
export const EDIT_MEMBER = 'EDIT_MEMBER';
export const ADD_MEMBER = 'ADD_MEMBER';
export const SET_RECENT_MEMBERS_LIST= 'SET_RECENT_MEMBERS_LIST';
