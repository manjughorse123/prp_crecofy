    ...
    <div id="recommendations">
        ...
        <div class="main-articles-sold">
            <div class="top-section">
                <div class="badges">
                    <span class="badge bg-primary" v-for="product in selectedProducts" :key="product.name">{{ product.name }}<a
                            href="javascript:void(0);" v-on:click="$parent.removeProduct(product.id)"><CancelIcon/></a></span>
                ...
                <div class="collapse recommended-collapse" id="soldarticles">
                    <div class="inner-collapse">
                        <div class="holder">
                            ...
                            <div v-for="recProduct in recProducts" :key="recProduct.id" style="margin-bottom: 20px;">

                                <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                                        :data-bs-target="'#product' + recProduct.id" aria-expanded="false"
                                        :aria-controls="'#product' + recProduct.id">
                                    <div class="toggle-head">
                                        <div class="table-layout">
                                            ...
                                            <div class="table-body">
                                                <div class="table-holder">
                                                    <div>{{ recProduct.id }}</div>
                                                    <div>{{ recProduct.name }}</div>
                                                    <div>{{ " - " }}</div>
                                                </div>
                                                <!--<div class="table-holder">
                                                  <div>00139</div>
                                        ...
                                        <div class="article-connection">
                                            ...
                                            <div class="value">{{ recProduct.percent.toFixed(2) }}%</div>
                                        </div>
                                    </div>
                                </button>

                                <div class="collapse" :id="'product' + recProduct.id">
                                    <div class="py-4">
