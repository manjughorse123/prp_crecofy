    ...
    <div class="modal-content">
      ...
      <Form @submit="onSubmit" :validation-schema="schema" v-slot="{ errors }" class="form-horizontal" action="#">
        <div class="modal-body">
          ...
          <div class="form-group" :class="{ 'has-error': errors.email }">
           ...
           <div class="form-group" :class="{ 'has-error': errors.birth_date}">
            ...
            <input type="text" ref="date" placeholder="Enter Birth date" class="form-control" v-model="formValues.birth_date"/>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="cancle-btn" data-dismiss="modal" v-on:click="clearForm()">Cancel</button>
        </div>
      </Form>
    </div>
  </div>
