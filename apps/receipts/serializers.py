...
class ArticleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Article
        fields =['id','name','number','gtin','product']
...
class ProductBoughtTogetherSerializer(serializers.Serializer):
    ...
    def to_representation(self, instance):
        return { 
            'product_id': instance[0],
            'product_name': instance[1],
            'category': instance[2],
            'total_bt': instance[3]
        }
...
class OrderLineSerializer1(serializers.ModelSerializer):
